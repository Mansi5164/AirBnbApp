...
import com.coding.shuttle.airBnb.entity.*;
import com.coding.shuttle.airBnb.entity.enums.BookingStatus;
import com.coding.shuttle.airBnb.exception.ResourceNotFoundException;
import com.coding.shuttle.airBnb.repository.*;
...
public class BookingServiceImpl implements  BookingService{
    ...
    public BookingDto initializeBooking(BookingRequest bookingRequest) {
        ...
        //Reserve the room and update the booked count of inventories
    ...
    public User getCurrentUser(){
        User user = new User();
        user.setId(1L);     //TODO : RETURN DUMMY USER THAT TIME
        return user;
    }
}
